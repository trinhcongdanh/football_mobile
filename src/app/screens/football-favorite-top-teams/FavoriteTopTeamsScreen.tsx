    ...
    return (
        <View style={[appStyles.flex]}>
            ...
            <FavoriteTopTeam
                ...
                newFav={getProfile.success ? formattedFavTopTeamsProfile : formattedFavTopTeams}
                favSelected={getProfile.success ? selectedFavTopTeamsProfile : selectedFavTopTeams}
