...
import { useViewModel } from './Appearances.viewModel';
import { IAppearancesProps } from '@football/app/screens/football-national-team/layout/appearances/Appearances.type';

export const Appearances = ({ topTeam }: IAppearancesProps) => {
    const { getTranslationText, t, onNavigateAppearances, onNavigatePlayerData } = useViewModel({
        topTeam,
    });
    return (
