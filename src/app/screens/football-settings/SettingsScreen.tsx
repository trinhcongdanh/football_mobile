        ...
        <View style={appStyles.flex}>
            ...
            <BackGround>
                ...
                <ScrollView
                    ...
                    ref={scrollViewRef}
                    onContentSizeChange={() => scrollBottom && scrollViewRef.current?.scrollToEnd()}
                ...
                >
                    <View style={styles.card_view_container}>
                        ...
                        <View style={styles.txt_container_avatar}>
                            <Text style={styles.txt_avatar}>{renderUserPoints(getProfile, t)}</Text>
                            <FastImage
                        ...
                        <View style={styles.block_container}>
                            <View
                                style={[appStyles.flex_row_align, { marginBottom: getSize.m(6) }]}
                            >
                                <Icon
                                ...
                                />
                                <Text style={styles.txt_title_block}>{t('settings.personal')}</Text>
                            </View>
