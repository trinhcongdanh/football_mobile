...
export const favTopTeamSlice = createSlice({
    ...
    reducers: {
        ...
        addSelectedFavTopTeams:(state,action)=>{
            state.selectedTopTeams=action.payload;
        },
...
export const { setFavTopTeams, pushFavTopTeam, resetTopTeams,resetSelectedFavTopTeams,addSelectedFavTopTeams } = actions;
